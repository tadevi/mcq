      ...
      <Table selectable basic={"very"}>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell>Thời gian làm</Table.HeaderCell>
          ...
          {(this.state.exam.answers || []).map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <Table.Cell>
                  <Moment format={"DD/MM/YY HH:mm "}>{item.start}</Moment>
                </Table.Cell>
      ...
      return (
        <div>
          <List>
            ...
            {this.state.exam.plan === PLAN_TYPE.PRO ? (
              <List.Item style={{ marginTop: "10px" }}>
                {this.renderHeader("Loại đề thi", "")}
                <Plan plan={this.state.exam.plan} />
              </List.Item>
            ) : (
              <div />
            )}
          ...
          <Grid.Column width={12}>
            <Segment>
              ...
              <Grid centered columns={2}>
                <Grid.Column width={4}>
                  <Image src={`${SERVER_FILES}/exam_icon.png`} />
                </Grid.Column>
                <Grid.Column width={12}>
                  {
                    <div>
            ...
            {!_.isEmpty(this.state.exam.answers) ? (
